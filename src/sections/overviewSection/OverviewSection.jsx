    ...
    <section className="overviewSection">
      <div className="main_container">
        <div className="content_container relative">
          <p className="text-[#b91813] fz-32 uppercase pt-[100px]">Introduction</p>
          <h1 className="fz-64 font-bold sm:mt-10 mt-5">Overview</h1>
          <p
            className="text-lg md:w-[55%] w-100 mb-10 mt-5 sm:text-justify text-left"
          >
          ...
          <CustomButton
            ...
            pdfFile={CVPDF}
          />
          <div className="sm:absolute w-full sm:bottom-[100px] bottom-[50px] left-0 sm:px-[20px]" style={{
